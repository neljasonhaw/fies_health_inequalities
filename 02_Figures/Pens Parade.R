...
## Tobacco
# 2012
tobacco_2012_new2015_pen_final <-
  pens_parade_plot(a = 1, b = poor_new2015_mult, d = diff_poor_new2015_mult_tobacco,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_tobacco,
                   g = 0, h = 0.30, i = 0, j = 1.5, k = 0.225, l = 0.26, m = 0.8, n = 1.1,
                   o = "Tobacco 2012", p1 = 0.64, q1 = 0.56, r1 = 0.72,
                   p2 = 0.25, q2 = 0.24, r2 = 0.27,
...
tobacco_2015_new2015_pen_final <-
  pens_parade_plot(a = 2, b = poor_new2015_mult, d = diff_poor_new2015_mult_tobacco,
                   ...
                   o = "Tobacco 2015", p1 = 0.84, q1 = 0.75, r1 = 0.94,
                   p2 = 0.29, q2 = 0.27, r2 = 0.31,
                   s = 0.05, t = 0.3, u = 0, v = 0.5) +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank())
# 2018
tobacco_2018_new2015_pen_final <-
  pens_parade_plot(a = 3, b = poor_new2015_mult, d = diff_poor_new2015_mult_tobacco,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_tobacco,
                   g = 0, h = 0.30, i = 0, j = 1.5, k = 0.145, l = 0.18, m = 0.75, n = 1.1,
                   o = "Tobacco 2018", p1 = 0.61, q1 = 0.56, r1 = 0.67,
                   p2 = 0.16, q2 = 0.15, r2 = 0.17,
                   s = 0.05, t = 0.3, u = 0, v = 0.5) +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank())
...
## Alcohol
# 2012
alcohol_2012_new2015_pen_final <-
  pens_parade_plot(a = 1, b = poor_new2015_mult, d = diff_poor_new2015_mult_alcohol,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_alcohol,
                   g = 0, h = 0.30, i = 0, j = 1.5, k = 0.225, l = 0.26, m = 0.8, n = 1.1,
                   o = "Alcohol 2012", p1 = 0.37, q1 = 0.31, r1 = 0.44,
                   p2 = 0.13, q2 = 0.12, r = 0.14,
                   s = 0.05, t = 0.3, u = 0, v = 0.5) +
  theme(axis.title.x = element_blank())
# 2015
alcohol_2015_new2015_pen_final <-
  pens_parade_plot(a = 2, b = poor_new2015_mult, d = diff_poor_new2015_mult_alcohol,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_alcohol,
                   g = 0, h = 0.30, i = 0, j = 1.5, k = 0.21, l = 0.245, m = 0.7, n = 1.1,
                   o = "Alcohol 2015", p1 = 0.36, q1 = 0.30, r1 = 0.42,
                   p2 = 0.10, q2 = 0.09, r2 = 0.11,
                   s = 0.05, t = 0.3, u = 0, v = 0.5) +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank())
# 2018
alcohol_2018_new2015_pen_final <-
  pens_parade_plot(a = 3, b = poor_new2015_mult, d = diff_poor_new2015_mult_alcohol,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_alcohol,
                   g = 0, h = 0.30, i = 0, j = 1.5, k = 0.145, l = 0.18, m = 0.8, n = 1.1,
                   o = "Alcohol 2018", p1 = 0.25, q1 = 0.22, r1 = 0.28,
                   p2 = 0.059, q2 = 0.057, r2 = 0.062,
                   s = 0.05, t = 0.3, u = 0, v = 0.5) +
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank())
...
## Health OOP
# 2012
health_2012_new2015_pen_final <-
  pens_parade_plot(a = 1, b = poor_new2015_mult, d = diff_poor_new2015_mult_health,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_health,
                   g = 0, h = 0.90, i = 0, j = 6, k = 0.22, l = 0.3, m = 0.4, n = 1.2,
                   o = "Health OOP 2012", p1 = 1.03, q1 = 0.93, r1 = 1.14,
                   p2 = 0.41, q2 = 0.35, r2 = 0.48,
...
health_2015_new2015_pen_final <-
  pens_parade_plot(a = 2, b = poor_new2015_mult, d = diff_poor_new2015_mult_health,
                   ...
                   o = "Health OOP 2015", p1 = 1.01, q1 = 0.92, r1 = 1.12,
                   p2 = 0.38, q2 = 0.32, r2 = 0.44,
                   s = 0, t = 0.65, u = 2.6, v = 5.5) +
  theme(axis.title.y = element_blank())
# 2018
health_2018_new2015_pen_final <-
  pens_parade_plot(a = 3, b = poor_new2015_mult, d = diff_poor_new2015_mult_health,
                   e = fracrank_poor_new2015_mult, f = pov_change_new2015_health,
                   g = 0, h = 0.90, i = 0, j = 6, k = 0.145, l = 0.22, m = 0.1, n = 1.3,
                   o = "Health OOP 2018", p1 = 0.58, q1 = 0.53, r1 = 0.63,
                   p2 = 0.20, q2 = 0.13, r2 = 0.26, 
                   s = 0, t = 0.65, u = 2.8, v = 5.5)  +
  theme(axis.title.y = element_blank())
###############################################################################
...
tobacco_plots <- list(tobacco_2012_new2015_pen_final, tobacco_2015_new2015_pen_final, tobacco_2018_new2015_pen_final)
alcohol_plots <- list(alcohol_2012_new2015_pen_final, alcohol_2015_new2015_pen_final, alcohol_2018_new2015_pen_final)
health_plots <- list(health_2012_new2015_pen_final, health_2015_new2015_pen_final, health_2018_new2015_pen_final)
...
ggsave("pens_parade.tiff", plot = pens_parade_full, width = 24, height = 18, units = "cm", scale = 2.8)
